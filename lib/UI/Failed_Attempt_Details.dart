...
class FailedAttempsDetails extends  StatefulWidget {


  ColiController controller = Get.find();

  @override
  _FailedAttempsDetailsState createState() => _FailedAttempsDetailsState();
}

class _FailedAttempsDetailsState extends State<FailedAttempsDetails> {
  ...
  Widget getBody(){
    ...
    print(index);
    phone = controller.listFailedAttempt[index!].reciverPhone != null ?controller.listFailedAttempt[index!].reciverPhone:controller.listFailedAttempt[index!].reciverPhone;
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(controller.listFailedAttempt[index!].code!,style: TextStyle(
                              fontSize: 12,color: Colors.black,
                              fontWeight: FontWeight.bold
                          ),),
                        ],
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'From: '.tr +
                                        controller.listFailedAttempt[index!] .fromAddress!.address!
                                            .toUpperCase(),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(controller.listFailedAttempt[index!].reciverName!,style: TextStyle(
                              fontSize: 12,color: Colors.black,
                              fontWeight: FontWeight.bold
                          ),),
                        ],
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(controller.listFailedAttempt[index!].reciverPhone!.tr,style: TextStyle(
  ...
  int add (String amount , String shipingCost){
    ...
    var amountInt = (controller.listFailedAttempt[index!].amountToBeCollected!);
    var shipingCostInt = (controller.listFailedAttempt[index!].shippingCost!);
